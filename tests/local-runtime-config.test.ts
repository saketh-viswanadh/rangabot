...
import { DEFAULT_CHAT_MODEL, DEFAULT_KNOWLEDGE_BUDGET_BYTES, getConfiguredChatModel, getKnowledgeBudgetBytes, getLocalOllamaBaseUrl } from "../lib/local-runtime-config.ts";
