...
The ten routes include the canonical Charter and calculate current mastery from
the repository-owned JSON sources rather than copying public scores by hand.

The website social preview is `public/og-charter.png`. It was generated from the
approved warm editorial card and carries the canonical north-star promise.
