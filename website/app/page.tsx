...
import { charter, evidenceCards, masterySummary, pillars, repositoryUrl } from "../lib/site-content";
    ...
    <>
      <section className="home-hero section-shell">
        <div className="hero-copy">
          <span className="eyebrow">Extraordinary capability · ordinary machines</span>
          <h1>Your machine.<br /><em>Your models.</em><br />Their full potential.</h1>
          <p>Rangabot is an open, local-first personal intelligence system that helps people use efficient open models for meaningful conversation, learning, coding, analysis and creation.</p>
          <div className="hero-actions">
            <a className="button button-gold" href="/download">Install from source <span>→</span></a>
            <a className="text-link" href="/showcase">See how it works <span>↗</span></a>
          </div>
      ...
      <section className="charter-preview section-shell">
        <div><span className="eyebrow">The Rangabot charter</span><h2>AI people can own,<br />on machines they already have.</h2></div>
        <div><p>{charter.vision[0]}</p><blockquote>{charter.promise}</blockquote><a className="text-link" href="/charter">Read the vision, mission and principles <span>→</span></a></div>
      </section>
      ...
      <section className="pillar-grid section-shell">
        {pillars.map((pillar) => (
          <a className="pillar-card" href={pillar.href} key={pillar.eyebrow}>
      ...
      <section className="showcase-split section-shell">
        <div><span className="eyebrow">Local intelligence</span><h2>Private books become clear, cited teaching.</h2><p>See what Rangabot retrieved, where it came from and which parts rely on model background.</p><a className="text-link" href="/showcase">Open the product tour <span>→</span></a></div>
      ...
      <section className="evidence-band">
        ...
        <div className="section-shell band-action"><a className="button button-paper" href="/evidence">Inspect the evidence <span>→</span></a></div>
      </section>

      <section className="mastery-teaser section-shell">
        <div className="mastery-copy"><span className="eyebrow">Path to Mastery</span><h2>The roadmap follows the charter.</h2><p>Nine mastery paths and forty-five public capability nodes show what is dependable, what is training and exactly what must pass next.</p><div className="mastery-stat"><strong>{masterySummary.readiness}%</strong><span>capability readiness<br /><small>{masterySummary.fullyUnlocked} of {masterySummary.total} fully unlocked · evidence checked {masterySummary.verifiedAt}</small></span></div><a className="button button-ink" href="/mastery">Enter the mastery tree <span>→</span></a></div>
      ...
      <section className="community-call section-shell">
        ...
        <div className="community-actions"><a className="button button-gold" href="/community">Find a contribution <span>→</span></a><a className="text-link" href={repositoryUrl}>View GitHub <span>↗</span></a></div>
      </section>
    </>
  );
}
