  ...
  return (
    <>
      ...
      <section className="mastery-teaser section-shell">
        <div className="mastery-copy"><span className="eyebrow">Path to Mastery</span><h2>The roadmap is alive.</h2><p>Forty-five public capability nodes show what is dependable, what is training and exactly what must pass next.</p><div className="mastery-stat"><strong>18%</strong><span>capability readiness<br /><small>8 of 45 fully unlocked · evidence checked 2 Aug 2026</small></span></div><a className="button button-ink" href="/mastery">Enter the mastery tree <span>→</span></a></div>
