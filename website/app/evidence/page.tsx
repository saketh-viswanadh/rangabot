...
const scores = [
  ...
  ["Analytical transfer", "12/12", "Astronomy v4 and separately frozen theatre v5 regressions", "Pass"],
  ["Trusted analytical narration", "44/44", "Canonical renders; 222/222 hostile mutations rejected", "Pass"],
] as const;
