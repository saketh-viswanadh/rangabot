...
import { masteryPaths, masterySummary, repositoryUrl } from "../../lib/site-content";
    ...
    <>
      ...
      <section className="mastery-overview section-shell">
        <div className="mastery-summary-grid">
          <div className="readiness-disc"><div><strong>{masterySummary.readiness}%</strong><span>Capability readiness<br />{masterySummary.fullyUnlocked} of {masterySummary.total} fully unlocked</span></div></div>
        ...
        <div className="callout"><strong>{masterySummary.development}% development progress is not {masterySummary.development}% product readiness.</strong><p>Partial criteria receive half-credit in the secondary development metric. The primary readiness figure counts only capabilities whose complete gate is verified. Evidence was last reconciled on {masterySummary.verifiedAt}.</p></div>
      </section>
