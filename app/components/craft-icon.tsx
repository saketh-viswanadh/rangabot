...
export type CraftIconName =
  ...
  | "mastery" | "memory" | "model" | "moon" | "more" | "pin" | "reply" | "search" | "send" | "shield"
  | "settings" | "spark" | "stop" | "sun" | "thumb-down" | "thumb-up" | "trash" | "tune";
...
export function CraftIcon({ name, size = 18, className = "", ...props }: CraftIconProps) {
  const paths: Record<CraftIconName, ReactNode> = {
    ...
    model: <><rect x="3.5" y="4" width="13" height="12" rx="2" /><path d="M6.5 8h7M6.5 11h4.5" /><circle cx="13.5" cy="12.5" r="1" /></>,
    ...
    "thumb-down": <><path d="M7 4.5h6.2c1 0 1.7.7 1.9 1.6l.8 4.1c.2 1.2-.7 2.3-1.9 2.3h-3l.3 2.3c.1.9-.6 1.7-1.5 1.7l-3.3-5H4.2V5.2H7Z" /><path d="M7 5v6.5" /></>,
    "thumb-up": <><path d="M7 15.5h6.2c1 0 1.7-.7 1.9-1.6l.8-4.1c.2-1.2-.7-2.3-1.9-2.3h-3l.3-2.3c.1-.9-.6-1.7-1.5-1.7l-3.3 5H4.2v6.3H7Z" /><path d="M7 15V8.5" /></>,
